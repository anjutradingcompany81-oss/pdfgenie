...
export default function TranslatePage() {
  ...
  return (
    ...
    >
      <div className="max-w-2xl space-y-6">
        <div className="grid items-center gap-3 sm:grid-cols-[1fr_auto_1fr]">
          ...
          <button
            ...
            className="mx-auto flex h-9 w-9 items-center justify-center rounded-full border border-brand-brown-dark/15 text-brand-brown-dark/60 transition-colors hover:border-brand-blue/40 hover:text-brand-blue-deep"
          >
      ...
      <p className="mt-6 max-w-2xl text-xs text-brand-brown-dark/45">
