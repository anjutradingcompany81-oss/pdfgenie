        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <input
              ...
              className="w-full rounded-full border border-brand-brown-dark/15 bg-white px-5 py-3 text-sm text-brand-brown-dark placeholder:text-brand-brown-dark/35 focus:border-brand-blue focus:outline-none sm:max-w-xs"
            />
            <button
              type="button"
              data-hover="true"
