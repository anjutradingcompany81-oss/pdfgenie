    ...
    <div className="space-y-3">
      {PROVIDERS.map(({ id, label, Icon }) => (
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-full border border-brand-brown-dark/15 bg-white px-5 py-3 text-sm font-semibold text-brand-brown-dark transition-colors hover:border-brand-blue/40"
        >
          <Icon />
          {label}
        </button>
